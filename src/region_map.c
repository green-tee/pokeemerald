...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_CROSSGATE] = {MAP_GROUP(CROSSGATE_TOWN), MAP_NUM(CROSSGATE_TOWN), HEAL_LOCATION_CROSSGATE_TOWN},
    ...
    [MAPSEC_CINNABAR_ISLAND] = {MAP_GROUP(CINNIBAR_ISLAND), MAP_NUM(CINNIBAR_ISLAND), HEAL_LOCATION_CINNIBAR_ISLAND},
    ...
    [MAPSEC_NEWBARK] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), HEAL_LOCATION_NEW_BARK_TOWN},
    [MAPSEC_CHERRYGROVE] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), HEAL_LOCATION_CHERRYGROVE_CITY},
    [MAPSEC_VIOLET] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), HEAL_LOCATION_VIOLET_CITY},
    [MAPSEC_AZALEA] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), HEAL_LOCATION_AZALEA_TOWN},
    [MAPSEC_GOLDENROD] = {MAP_GROUP(GOLDENROD_CITY), MAP_NUM(GOLDENROD_CITY), HEAL_LOCATION_GOLDENROD_CITY},
    [MAPSEC_ECRUTEAK] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), HEAL_LOCATION_ECRUTEAK_CITY},
    [MAPSEC_OLIVINE] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), HEAL_LOCATION_OLIVINE_CITY},
    [MAPSEC_CYANWOOD] = {MAP_GROUP(CYANWOOD_CITY), MAP_NUM(CYANWOOD_CITY), HEAL_LOCATION_CYANWOOD_CITY},
    [MAPSEC_MAHOGANY] = {MAP_GROUP(MAHOGANY_TOWN), MAP_NUM(MAHOGANY_TOWN), HEAL_LOCATION_MAHOGANY_TOWN},
    [MAPSEC_BLACKTHORN] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), HEAL_LOCATION_BLACKTHORN_CITY},
    [MAPSEC_ROUTE_28] = {MAP_GROUP(MT_SILVER_F2), MAP_NUM(MT_SILVER_F2), HEAL_LOCATION_MT_SILVER_F2},
    [MAPSEC_INDIGO_PLATEAU] = {MAP_GROUP(INDIGO_PLATEAU), MAP_NUM(INDIGO_PLATEAU), HEAL_LOCATION_INDIGO_PLATEAU},
    [MAPSEC_LAKE_OF_RAGE] = {MAP_GROUP(LAKEOF_RAGE), MAP_NUM(LAKEOF_RAGE), HEAL_LOCATION_LAKEOF_RAGE},
    [MAPSEC_BATTLE_TOWER] = {MAP_GROUP(JOHTO_BATTLE_TOWER), MAP_NUM(JOHTO_BATTLE_TOWER), HEAL_LOCATION_JOHTO_BATTLE_TOWER},   
    [MAPSEC_JOHTO_SAFARI] = {MAP_GROUP(JOHTO_SAFARI), MAP_NUM(JOHTO_SAFARI), HEAL_LOCATION_JOHTO_SAFARI},
    [MAPSEC_ROUTE_3] = {MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3), HEAL_LOCATION_ROUTE3},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_CROSSGATE:
        return FlagGet(FLAG_UNUSED_0x493) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VERMILION_CITY:
        return FlagGet(FLAG_UNUSED_0x494) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CELADON_CITY:
        return FlagGet(FLAG_UNUSED_0x495) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CERULEAN_CITY:
        return FlagGet(FLAG_UNUSED_0x496) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CINNABAR_ISLAND:
        return FlagGet(FLAG_UNUSED_0x497) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FUCHSIA_CITY:
        return FlagGet(FLAG_UNUSED_0x498) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LAVENDER_TOWN:
        return FlagGet(FLAG_UNUSED_0x499) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PEWTER_CITY:
        return FlagGet(FLAG_UNUSED_0x49A) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VIRIDIAN_CITY:
        return FlagGet(FLAG_UNUSED_0x49B) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PALLET_TOWN:
        return FlagGet(FLAG_UNUSED_0x49C) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_28:
        return FlagGet(FLAG_UNUSED_0x49D) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_INDIGO_PLATEAU:
        return FlagGet(FLAG_UNUSED_0x49E) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_NEWBARK:
        return FlagGet(FLAG_UNUSED_0x49F) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CHERRYGROVE:
        return FlagGet(FLAG_UNUSED_0x4A0) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VIOLET:
        return FlagGet(FLAG_UNUSED_0x4A1) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_AZALEA:
        return FlagGet(FLAG_UNUSED_0x4A2) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GOLDENROD:
        return FlagGet(FLAG_UNUSED_0x4A3) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ECRUTEAK:
        return FlagGet(FLAG_UNUSED_0x4A4) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OLIVINE:
        return FlagGet(FLAG_UNUSED_0x4A5) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CYANWOOD:
        return FlagGet(FLAG_UNUSED_0x4A6) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MAHOGANY:
        return FlagGet(FLAG_UNUSED_0x4A7) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LAKE_OF_RAGE:
        return FlagGet(FLAG_UNUSED_0x4A8) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BLACKTHORN:
        return FlagGet(FLAG_UNUSED_0x4A9) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BATTLE_TOWER:
        return FlagGet(FLAG_UNUSED_0x4AA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JOHTO_SAFARI:
        return FlagGet(FLAG_UNUSED_0x4AB) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SAFFRON_CITY:
        return FlagGet(FLAG_UNUSED_0x4AC) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_3:
        return FlagGet(FLAG_UNUSED_0x4AD) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_10:
        return FlagGet(FLAG_UNUSED_0x4AE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
