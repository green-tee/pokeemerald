...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SURGE] = REMATCH(TRAINER_SURGE_1, TRAINER_SURGE_2, TRAINER_SURGE_3, TRAINER_SURGE_4, TRAINER_SURGE_5, VERMILION_CITY),
    [REMATCH_FALKNER] = REMATCH(TRAINER_FALKNER_1, TRAINER_FALKNER_2, TRAINER_FALKNER_3, TRAINER_FALKNER_4, TRAINER_FALKNER_5, VIOLET_CITY),
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    case SPECIES_DEOXYS:
        ...
        break;
    case SPECIES_HO_OH:
        CreateBattleStartTask(B_TRANSITION_BLUR, HOOH);
        break;
    case SPECIES_LUGIA:
        CreateBattleStartTask(B_TRANSITION_BLUR, LUGIA);
        break;
