...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_CROSSGATE] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_ROUTE_100] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_OLIVINE] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_ROUTE_40] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_41] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_CYANWOOD] = MAPPOPUP_THEME_STONE,
	[MAPSEC_ROUTE_47] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_48] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_JOHTO_SAFARI] = MAPPOPUP_THEME_STONE,
	[MAPSEC_ROUTE_38] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_39] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_RUINS_OF_ALPH] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_DARK_CAVE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_ICE_PATH] = MAPPOPUP_THEME_STONE,
	[MAPSEC_CHERRYGROVE] = MAPPOPUP_THEME_BRICK,
	[MAPSEC_LAKE_OF_RAGE] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_MAHOGANY] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_GOLDENROD] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_NATIONAL_PARK] = MAPPOPUP_THEME_BRICK,
	[MAPSEC_WHIRL] = MAPPOPUP_THEME_STONE,
	[MAPSEC_SPROUTTOWER] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_TINTOWER] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_BURNEDTOWER] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ROUTE_42] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_GATE] = MAPPOPUP_THEME_STONE
