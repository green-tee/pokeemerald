...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_LAVENDER_TOWN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PEWTER_CITY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_NEWBARK] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_AZALEA] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_MAHOGANY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_OLIVINE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ECRUTEAK] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_VIOLET] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_GOLDENROD] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CYANWOOD] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_BLACKTHORN] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_SEAFOAM_ISLANDS] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_JOHTO_ROCKET_HIDEOUT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MTMORTAR] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNION_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_RUINS_OF_ALPH] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DARK_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DRAGONSDEN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_WHIRL] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_ICE_PATH] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_MTSILVER] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SLOWPOKE_WELL] = MAPPOPUP_THEME_STONE,
    [MAPSEC_BURNEDTOWER] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TINTOWER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_TOHJO_FALLS] = MAPPOPUP_THEME_STONE,
    [MAPSEC_OLIVINE_LIGHTHOUSE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_NATIONAL_PARK] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_99] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_98] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BILLSGARDEN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FAROFFCAVE] = MAPPOPUP_THEME_STONE,
